...
public class ServicioWebGestionarCancionesDePlaylist extends Worker {
    public ServicioWebGestionarCancionesDePlaylist(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String direccion = "http://ec2-54-93-62-124.eu-central-1.compute.amazonaws.com/jlopezdeahumad001/WEB/gestionarCancionesDePlaylist.php";
        ...
        try {
            ...
            //Como hay que eliminar una canción se reciben sus datos
            ...
            if (statusCode == 200) {
                ...
                Toast.makeText(getApplicationContext(), "Ha ocurrido un error en la gestión de las canciones de la playlist", Toast.LENGTH_LONG).show();
                Log.d("servicioWeb", "Status Gestionar Canciones De Playlist no es 200");
            }
