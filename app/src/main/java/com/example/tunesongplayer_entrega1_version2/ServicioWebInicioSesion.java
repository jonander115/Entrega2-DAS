...
public class ServicioWebInicioSesion extends Worker {
    public ServicioWebInicioSesion(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String direccion = "http://ec2-54-93-62-124.eu-central-1.compute.amazonaws.com/jlopezdeahumad001/WEB/inicioSesion.php";
        ...
        try {
            ...
            if (statusCode == 200) {
                ...
                Toast.makeText(getApplicationContext(), "Ha ocurrido un error en el inicio de sesión", Toast.LENGTH_LONG).show();
                Log.d("servicioWeb", "Status Inicio Sesión no es 200");
            }
