...
public class ServicioWebRegistro extends Worker {
    public ServicioWebRegistro(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String direccion = "http://ec2-54-93-62-124.eu-central-1.compute.amazonaws.com/jlopezdeahumad001/WEB/registro.php";
        ...
        try {
            ...
            if (statusCode == 200) {
                ...
                Toast.makeText(getApplicationContext(), "Ha ocurrido un error en el registro", Toast.LENGTH_LONG).show();
                Log.d("servicioWeb", "Status Registro no es 200");
            }
